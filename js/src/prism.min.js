 ...
 */
/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+actionscript+ada+applescript+aspnet+bash+basic+bison+c+csharp+cpp+cmake+css-extras+d+docker+erlang+git+go+http+hpkp+hsts+icon+java+javadoc+javadoclike+js-extras+js-templates+json+jsonp+json5+lua+makefile+markdown+markup-templating+matlab+nasm+nginx+objectivec+perl+php+powerquery+powershell+python+sql+swift+typescript+t4-cs+t4-vb+t4-templating+vbnet+vim+visual-basic+yaml&plugins=line-highlight+line-numbers+show-language+jsonp-highlight+highlight-keywords+toolbar+copy-to-clipboard */
...
!function(){if("undefined"!=typeof self&&self.Prism&&self.document)if(Prism.plugins.toolbar){var r=window.ClipboardJS||void 0;r||"function"!=typeof require||(r=require("clipboard"));var i=[];if(!r){var o=document.createElement("script"),e=document.querySelector("head");o.onload=function(){if(r=window.ClipboardJS)for(;i.length;)i.pop()()},o.src="/js/src/clipboard.min.js",e.appendChild(o)}Prism.plugins.toolbar.registerButton("copy-to-clipboard",function(e){var t=document.createElement("button");return t.textContent="复制",r?o():i.push(o),t;function o(){var o=new r(t,{text:function(){return e.code}});o.on("success",function(){t.textContent="已复制!",n()}),o.on("error",function(){t.textContent="按 Ctrl+C 复制",n()})}function n(){setTimeout(function(){t.textContent="复制"},5e3)}})}else console.warn("Copy to Clipboard plugin loaded before Toolbar plugin.")}();
